// screens/admin/deliveryStatusOrder/PendingOrders.tsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { useGetPendingDeliveriesQuery } from '@/redux/features/deliveryOrderStatusApi/deliveryOrderStatusApi';
...
export const PendingOrders: React.FC = () => {
  ...
  const { data, isLoading, refetch } = useGetPendingDeliveriesQuery({
    page,
    limit,
  ...
  return (
    <div className="lg:bg-white lg:p-8 lg:rounded-[12px]">
      <h1 className="text-2xl font-semibold text-gray-900 mb-6">Pending Orders</h1>
