// screens/admin/deliveryStatusOrder/AssignedOrders.tsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { useGetAssignedDeliveriesQuery } from '@/redux/features/deliveryOrderStatusApi/deliveryOrderStatusApi';
...
export const AssignedOrders: React.FC = () => {
    ...
    const { data, isLoading, refetch } = useGetAssignedDeliveriesQuery({
        page,
        limit,
    ...
    return (
     <div className="lg:bg-white lg:p-8 lg:rounded-[12px]">
            <h1 className="text-2xl font-semibold text-gray-900 mb-6">Assigned Orders</h1>
