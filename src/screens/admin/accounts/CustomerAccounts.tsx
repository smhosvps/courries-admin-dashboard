...
export default function CustomerAccounts() {
  ...
  // Filter users - only show customers
        ...
        <div className="bg-white rounded-xl overflow-hidden">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 border-b border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <Link
                to="/dashboard-super-admin/admin-add-account-csv"
                className="w-full sm:w-auto"
              >
                <Button className="w-full sm:w-auto border border-gray-300 rounded-full bg-white text-gray-700 hover:bg-gray-50">
                  Add Account CSV
                </Button>
              </Link>
              <Link
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full shadow-xl">
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 p-6 border-t rounded-b-xl border-gray-200 bg-gray-50">
              <button
                onClick={cancelDelete}
                className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition w-full"
                disabled={isDeleting}
              >
                Cancel
              </button>
              <button
                ...
                disabled={isDeleting}
                className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition disabled:opacity-50 disabled:cursor-not-allowed w-full"
              >
