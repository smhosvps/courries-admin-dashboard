...
export default function AdminAccount() {
  ...
  useEffect(() => {
    ...
    if (error) {
      ...
      toast.error(errorData.data?.message || "Failed to delete admin");
    }
        ...
        <div className="bg-white rounded-xl overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 border-b border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              ...
              >
                <Button className="w-full sm:w-auto bg-[#1969fe] hover:bg-blue-600 rounded-full text-white">
          ...
          {filteredUsers.length === 0 ? (
            <div className="text-center py-12 text-gray-500 bg-gray-50 m-4 rounded-lg">
              No admins found
            </div>
          ) : (
            <>
                ...
                <div className="inline-block min-w-full align-middle">
                  <table className="min-w-full border-collapse">
                    ...
                    <tbody className="bg-white">
                      {currentEntries.map((user:any, index:any) => (
                        <tr
                          key={user._id}
                        ...
                        >
                          ...
                          <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap border border-gray-200 text-sm text-gray-600 capitalize">
                            {user?.userType || "-"}
                          </td>
                          <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap border border-gray-200">
                          ...
                          return (
                            <Button
                              ...
                              className={`w-8 h-8 p-0 rounded-full text-white ${
                                currentPage === pageNum ? "bg-[#1969fe] hover:bg-blue-600" : "bg-[#1969fe] hover:bg-blue-600"
                              }`}
                            >
                              {pageNum}
                            </Button>
          ...
          <div className="bg-white rounded-xl max-w-md w-full shadow-xl">
            ...
            <div className="p-6">
              <p className="text-gray-600">
                Are you sure you want to delete the admin account of{" "}
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50 rounded-b-xl">
              <button
                onClick={cancelDelete}
