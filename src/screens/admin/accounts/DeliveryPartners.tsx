...
export default function DeliveryPartners() {
  ...
  // Filter users - only delivery partners
  const filteredUsers = (data?.users || []).filter((user: any) => {
    if (user.userType !== "delivery_partner") return false;
  ...
  useEffect(() => {
    if (isSuccess) {
      toast.success("Delivery partner successfully deleted.");
      refetch();
    ...
    if (error) {
      ...
      toast.error(
        errorData.data?.message || "Failed to delete delivery partner"
      );
    }
              ...
              <>
                ...
                <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                  <div className="text-sm text-gray-600 order-2 sm:order-1">
                    ...
                    {filteredUsers.length} delivery partners
                  </div>
          ...
          <div className="bg-white rounded-xl max-w-md w-full shadow-xl">
            ...
            <div className="p-6">
              <p className="text-gray-600">
                Are you sure you want to delete the delivery partner account of{" "}
